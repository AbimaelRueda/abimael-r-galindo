...
import CV from '../../../files/CV Abimael Rueda.pdf';
import CVEnglish from '../../../files/CV Abimael Rueda G.pdf';
    ...
    <section className={`contact-section ${themeValue ? 'contact-section-lt' : 'contact-section-dt'}`} id="contact">
      ...
      <div className="contact-container">
        ...
        <div className="container-cv" data-aos="zoom-in-left">
          ...
          <a type="button" href={languageValue ? CV : CVEnglish} className="button-contact-section" download="CV Abimael Rueda">
